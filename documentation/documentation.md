...
displaying assets with a browser.  We ensure that HTML is rendered client side
...
a framework for handling API calls and provide proper API documentation in an easy way. Other
important npm packages used in the project's backend are serve-static for handling static assets
